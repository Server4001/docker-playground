...
function dockerpress_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'dockerpress' ),
	) );
...
function dockerpress_scripts() {
	wp_enqueue_style( 'dockerpress-style', get_stylesheet_uri() );

	wp_enqueue_script( 'dockerpress-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'dockerpress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
